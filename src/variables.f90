module variables 
    ...
    integer :: ndv ! Number of V1 values
    ...
    integer :: k1 ! Momentum index 1
    integer :: k2 ! Momentum index 2

    double precision, allocatable :: evals(:)

    ! Bonds, sites, and lattice
    ! integer                      :: nnBonds, nnnBonds
    ! integer, allocatable         :: bsites(:,:), hexsites(:,:), xy(:,:), xyA(:,:), xyB(:,:), geopar%latticevecs(:)
    ...
    integer :: conf, nest, nv, nv2
    ! integer                      :: nDeg, unit, refsite, conf, nest, cntrA, cntrB
    ! integer                      :: nev, ncv, ndv, ndv2, full, nHel, tilt
